package online.foursstudio.throttlingserver.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(online.foursstudio.throttlingserver.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(online.foursstudio.throttlingserver.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
